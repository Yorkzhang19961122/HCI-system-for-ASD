...
async def test_control_behavior():
    ...
    block: ControlBehavior = ControlBehavior(name="dance_0001", control_type=RobotBehaviorControlType.START)
        ...
        while True:
            ...
            if len(faceRects) > 0:
                for faceRect in faceRects:
                    ...
                    #机器人互动
                    if emo=='happy'and flag_happy:  #识别到第三个happy且flag为True时，flag由按键触发True
                        count1 = count1 + 1
                        #print('count1:', count1)
                        if count1 >= 3:
