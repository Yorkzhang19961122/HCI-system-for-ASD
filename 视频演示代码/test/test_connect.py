...
async def test_get_device_by_name():
    ...
    result: WiFiDevice = await MiniSdk.get_device_by_name("00852", 10)
...
if __name__ == '__main__':
    ...
    #device: WiFiDevice = asyncio.get_event_loop().run_until_complete(test_get_device_list())
    if device:
        #创建一个事件循环asyncio.get_event_loop(),执行事件run_until_compete()
