...
emo_labels = ['sad', 'disgust', 'fear', 'happy', 'sad', 'surprise', 'neutral']
                ...
                for faceRect in faceRects:
                    ...
                    if emo == 'happy' and flag_happy:
                        ...
                        if count1 >= 3:
                            ...
                            asyncio.get_event_loop().run_until_complete(test_play_tts1())
                        ...
                        if count3 >= 3:
                            asyncio.get_event_loop().run_until_complete(asyncio.sleep(2))
                            asyncio.get_event_loop().run_until_complete(test_play_tts3())
                            flag_sad = False
                ...
                try:
                    ...
                    while images_loader.has_image():
                        ...
                        if len(dict_id2skeleton):
                            ...
                            if dict_id2label[min_id] == 'stand':
                                count = count + 1
                                if count >= 3:
                                    #asyncio.get_event_loop().run_until_complete(test_play_action_test())
                                    ###stand
                            ...
                            #print('count= ', count)
                            elif dict_id2label[min_id] == 'squat':
                                count1 = count1 + 1
                                if count1 >= 3:
